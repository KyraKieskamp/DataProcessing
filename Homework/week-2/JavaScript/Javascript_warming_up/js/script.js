...
// determining the lenght of the ingredients-list
var x = ApplePie.ingredients.length;

// prints out the element in the ingredients array at index i
for (var i = 0; i < x; i++) {
...
// Selecting the html element containing the img using javascript selectors.
var imag = document.getElementsByTagName("img")[0];

// Adding an event to the html element containing the img using a javascript function.
// Passing print function to the event.
imag.addEventListener("click", say);
